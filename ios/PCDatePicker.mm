...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    ...
    // updateProps would otherwise read the base ViewProps as PCDatePickerProps.
    static const auto defaultProps = std::make_shared<const PCDatePickerProps>();
    _props = defaultProps;
    ...
    _datePickerView.onChangeHandler = ^(NSNumber *ms, BOOL confirmed, NSNumber *durationSeconds) {
      ...
      event.durationSeconds = durationSeconds.doubleValue;
