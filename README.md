...
| -------------------- | -------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| **TextField**        | `UITextField` / `UITextView` | `TextInputLayout` (Material 3: outlined or filled, label, supporting text, icons, counter) | [TextField](https://jarx-concepts.github.io/react-native-platform-components/components/textfield)             |
...
| **TabBar**           | `UITabBar` (floating Liquid Glass bar on iOS 26) | `BottomNavigationView` (Material 3 navigation bar)          | [TabBar](https://jarx-concepts.github.io/react-native-platform-components/components/tabbar)                     |
