...
/**
 * A destination, the same fields as a TabBar tab. Icons are pre-resolved on
 * the JS side (see icons.ts), the selected icon under the `selected…`
 * fields; empty strings mean "none".
 */
